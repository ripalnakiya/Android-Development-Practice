...
public class MyDialogManager {
    ...
    private void configureDialog(Context context) {
        ...
        dialogSpinner.setAdapter(getSpinnerAdapter(context));
    }
    ...
    private static ArrayAdapter<String> getSpinnerAdapter(Context context) {
        ...
        priorities.add("4");
        priorities.add("5");
        return new ArrayAdapter<>(context, android.R.layout.simple_spinner_dropdown_item, priorities);
    }
}
